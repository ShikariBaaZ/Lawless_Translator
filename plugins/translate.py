...
async def start(client, message):
          ...
          await message.reply_text(text =f"💐 Hello 💐 **{message.from_user.first_name }**. \n\nI am most simple and an effective Google Translator Bot.**I am able to translate any language to your selected language** ❤️My Dear❤️ **`{message.from_user.first_name }`**  __\n\n**Powerd By** @ShikariSupportNetwork. 🔥",
          reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Lawless Updates 🙋‍♀️", url="https://t.me/Lawless_Updates")],
               [InlineKeyboardButton("Bot Support 💬", url="https://t.me/ShikariSupportNetwork"),
	       InlineKeyboardButton("Scource 💾", url="https://Github.com/ShikariBaaZ/Lawless_Translator"),
	       InlineKeyboardButton("Devoloper 👑",url = "https://t.me/The_Shikarii")]])
	  ),
...
async def echo(client, message):
	...
	if code :
			...
			try:
					...
					await message.reply_text(f"Translated from **{translation.src}** To **{translation.dest}**\n\n```{translation.text}```\n\n We Are @ShikariSupportNetwork join @ShikariSupportNetwork 🔥")
	else:
		await  message.reply_text("Select language 🔽",reply_to_message_id = message.message_id, reply_markup =keybord1)
